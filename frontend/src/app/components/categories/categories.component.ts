...
export class CategoriesComponent {
  ...
  categories: Category[] = [
    ...
    { id: 'anime-pop', name: 'Anime & Pop Culture', icon: 'fa fa-sparkles', description: 'Your favorite anime characters and pop culture icons', color: 'from-pink-500 to-purple-500' },
